<template>
  ...
  <div>
    ...
    <h2>Infos</h2>
    <p>Dieser Webauftritt wird zur Zeit noch gebaut...</p>

    <h3>Thank-Yous</h3>
    <p>
      Diese App entstand aus einer Idee auf dem Junggesselnabschied in den Niederlanden von Sascha.<br/>
      Danke für das Wochenende!<br/>
      Und Euch, Mÿri und Sascha, alles Gute! - Und den Kids natürlich auch!
    </p>
    ...
    <div class="impressum">
      ...
      <p>Dirk Schumacher, Am Falkenberg 2, 51381 Leverkusen</p>
      <p>Vertreten durch: Dirk Schumacher</p>
      <p>
        Kontakt:<br/>
        Telefon: 01635836637<br/>
        E-Mail: info@coffeeshopfinder.de
      </p>
      <p>
